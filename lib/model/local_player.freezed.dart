...
abstract class $LocalPlayerCopyWith<$Res> {
  ...
  $Res call(
      {String name,
      @JsonKey(name: "color") @ColorConverter() Color? color,
      String? avatar,
      int? pts,
      int? playerNo,
      bool? isActive});
...
class _$LocalPlayerImpl extends _LocalPlayer {
  const _$LocalPlayerImpl(
      {required this.name,
      @JsonKey(name: "color") @ColorConverter() this.color = majorelleBlue,
      this.avatar,
      this.pts = 0,
      this.playerNo,
      this.isActive})
...
abstract class _LocalPlayer extends LocalPlayer {
  const factory _LocalPlayer(
      ...
      @JsonKey(name: "color") @ColorConverter() final Color? color,
      final String? avatar,
      final int? pts,
      final int? playerNo,
